/**
 * v2.6.34: backup import, full-week PTO, RTO on KC nights, period boot, license.
...
function staticChecks() {
  ...
  if (ver.version === '2.6.34') pass('version.json', ver.version);
  else fail('version.json', JSON.stringify(ver));

  if (index.includes("APP_VERSION = '2.6.34'") && sw.includes("msb-pro-v2.6.34")) {
    pass('app-sw-version');
  } else fail('app-sw-version', 'expected 2.6.34');
...
async function main() {
  console.log('\n=== v2.6.34 customer-fix integrity ===');
  staticChecks();
