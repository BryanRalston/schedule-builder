/**
 * v2.6.47: light appearance is the default; dark stays an on-device option.
...
async function browserChecks(base, chromium) {
  ...
  try {
    ...
    if (first.theme === 'light' && (first.stored == null || first.stored === 'light')
      && paperLight && brand && first.moreVal === 'light' && /v2\.6\.47/.test(first.version)) {
...
async function main() {
  console.log('\n=== v2.6.47 light default + logo accents ===');
  staticChecks();
